...
public class Urna
{
  ...
  //TODO Declare el atributo de candidato2
    ...
    public double calcularPorcentajeVotosPorInternetCandidato1( )
    {
    	...
    	double votosInternetTotales;
    	
    	//double porcentaje;
    	
    	numVotosInternetCandidato1 = candidato1.darVotosInfluenciaInternet( );
    	votosInternetTotales = calcularTotalVotosInternet( );
    	
    	//porcentaje = numVotosInternetCandidato1 / votosInternetTotales * 100;
    	return numVotosInternetCandidato1 / votosInternetTotales * 100;
    	//return porcentaje;
    }
    ...
    {
    	//TODO Complete el m�todo seg�n la documentaci�n.
    	double numVotosInternetCandidato2;
    	double votosInternetTotales;
    	
    	numVotosInternetCandidato2 = candidato2.darVotosInfluenciaInternet();
    	votosInternetTotales = calcularTotalVotosInternet();
    	
    	return numVotosInternetCandidato2 / votosInternetTotales * 100;
    }
    ...
    {
    	//TODO Complete el m�todo seg�n la documentaci�n.
    	double numVotosInternetCandidato3;
    	double votosInternetTotales;
    	
    	numVotosInternetCandidato3 = candidato3.darVotosInfluenciaInternet();
    	votosInternetTotales = calcularTotalVotosInternet();
    	
    	return numVotosInternetCandidato3 / votosInternetTotales * 100;
    }
