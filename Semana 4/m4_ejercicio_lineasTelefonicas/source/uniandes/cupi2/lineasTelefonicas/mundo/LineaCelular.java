...
/**
 * Clase que representa una l�nea telef�nica celular.  Hereda la clase LineaTelefonica.
 */
public class LineaCelular extends LineaTelefonica{
    ...
    {
        //
        //Una llamada m�s. Se modifica el atributo protegido heredado.
    ...
    public void agregarLlamadaCelular( int minutos )
    {
    	...
    	// Al hacer llamado super. entonces el darCostoLlamada en LineaTelefonica es supuestamente (minutos * 999) pero no es asi, el minuto 
    	// en esta linea vale 10, entonces por eso se modifica el costoLlamadas por - minutos*989, para tener el verdadero costo de una llamada
    	// celular por esta linea alternativa.
    ...
    /**
     * Reinicia la l�nea celular, dejando todos sus valores en cero.
     */
